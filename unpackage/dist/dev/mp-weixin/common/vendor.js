...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"edu-app","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 12:
/*!***********************************************!*\
  !*** G:/nuiapp/mxgsi/common/mixins/mixins.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
IndexModel = /*#__PURE__*/function () {function IndexModel() {_classCallCheck(this, IndexModel);}_createClass(IndexModel, null, [{ key: "handleOpenScanCode",
    ...
    // 开启扫码
    value: function () {var _handleOpenScanCode = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.prev = 0;_context.next = 3;return (


                  uni.scanCode());case 3:res = _context.sent;
                // 跳转到webview页面
                uni.navigateTo({
                  url: "/pages/public/web-view?url=".concat(res.result)
                ...
                console.log("error=>", _context.t0);case 10:case "end":return _context.stop();}}}, _callee, null, [[0, 7]]);}));function handleOpenScanCode() {return _handleOpenScanCode.apply(this, arguments);}return handleOpenScanCode;}()



    // 获取(热门推荐/近期上新/免费精选)课程列表数据
  }, { key: "getCourseList", value: function () {var _getCourseList = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var data,res,_args2 = arguments;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:data = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {};_context2.prev = 1;_context2.next = 4;return (

                  _index.default.getCourseList(_objectSpread({
                    current: IndexModel.current,
                    size: IndexModel.size },
                  data)));case 4:res = _context2.sent;return _context2.abrupt("return",

                res.records);case 9:_context2.prev = 9;_context2.t0 = _context2["catch"](1);


                //TODO handle the exception
                console.log("err", _context2.t0);case 12:case "end":return _context2.stop();}}}, _callee2, null, [[1, 9]]);}));function getCourseList() {return _getCourseList.apply(this, arguments);}return getCourseList;}() }]);return IndexModel;}();_defineProperty(IndexModel, "current", 1);_defineProperty(IndexModel, "size", 8);var _default =
...
var getBanner = function getBanner() {var position = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  return (0, _request.default)({ url: "/article/api/advert/show/".concat(position), method: 'GET' });
};
...
var getCourseList = function getCourseList(data) {
  return (0, _request.default)({ url: '/course/api/course/search', method: 'POST', data: data });
};
